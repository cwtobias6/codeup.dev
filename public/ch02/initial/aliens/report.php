...
<?php
  ...
  $dbc = mysqli_connect('127.0.0.1','practice','password','aliendatabase') 
          OR die('An error occurred connecting to the db brotha mayne');
  ...
  $result = mysqli_query($dbc,$query)
              OR die('failed to connect to the db dude');
